...
function sendApplicantCompletedMail_(p, requestId) {
  ...
  var body =
    ...
    '■当日の流れ\n' +
    '1) 入り口の体験チケットをお受け取りのうえ、インターホンを押してください。スタッフが開錠します。\n' +
    '2) 2階で、スタッフより当日のご案内（持ち物・ヨガマット貸出など）をいたします。\n' +
    '3) 3階へお上がりいただき、体験チケットをインストラクターへお渡しのうえ、レッスンにご参加ください。\n\n' +
    '※レッスンにより満員となる場合がございます。あらかじめご了承ください。\n' +
    '※タオルはご持参ください。ヨガマットのみ無料貸出（数に限りあり）です。\n\n' +
    '※本メールは自動送信です。\n' +
      ...
      '<div style="max-width:680px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:18px;overflow:hidden;box-shadow:0 12px 30px rgba(0,0,0,.06);">' +
        ...
        '<div style="padding:22px 24px 26px;">' +
          ...
          '<ol style="margin:0;padding-left:18px;font-size:14px;line-height:1.9;color:#374151;">' +
            '<li>入り口の体験チケットをお受け取りのうえ、インターホンを押してください。スタッフが開錠します。</li>' +
            '<li>2階で、スタッフより当日のご案内（持ち物・ヨガマット貸出など）をいたします。</li>' +
            '<li>3階へお上がりいただき、体験チケットをインストラクターへお渡しのうえ、レッスンにご参加ください。</li>' +
          '</ol>' +
